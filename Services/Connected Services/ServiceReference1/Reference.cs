...
namespace Services.ServiceReference1 {
    ...
    public interface billService {
        ...
        Services.ServiceReference1.getStatusResponse getStatus(Services.ServiceReference1.getStatusRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="urn:getStatus", ReplyAction="*")]
        System.Threading.Tasks.Task<Services.ServiceReference1.getStatusResponse> getStatusAsync(Services.ServiceReference1.getStatusRequest request);
        ...
        Services.ServiceReference1.sendBillResponse sendBill(Services.ServiceReference1.sendBillRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="urn:sendBill", ReplyAction="*")]
        System.Threading.Tasks.Task<Services.ServiceReference1.sendBillResponse> sendBillAsync(Services.ServiceReference1.sendBillRequest request);
        ...
        Services.ServiceReference1.sendPackResponse sendPack(Services.ServiceReference1.sendPackRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="urn:sendPack", ReplyAction="*")]
        System.Threading.Tasks.Task<Services.ServiceReference1.sendPackResponse> sendPackAsync(Services.ServiceReference1.sendPackRequest request);
        
        // CODEGEN: El parámetro 'ticket' requiere información adicional de esquema que no se puede capturar con el modo de parámetros. El atributo específico es 'System.Xml.Serialization.XmlElementAttribute'.
        [System.ServiceModel.OperationContractAttribute(Action="urn:sendSummary", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        [return: System.ServiceModel.MessageParameterAttribute(Name="ticket")]
        Services.ServiceReference1.sendSummaryResponse sendSummary(Services.ServiceReference1.sendSummaryRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="urn:sendSummary", ReplyAction="*")]
        System.Threading.Tasks.Task<Services.ServiceReference1.sendSummaryResponse> sendSummaryAsync(Services.ServiceReference1.sendSummaryRequest request);
    }
    ...
    public partial class getStatusResponse {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://service.sunat.gob.pe", Order=0)]
        [System.Xml.Serialization.XmlElementAttribute(Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public Services.ServiceReference1.statusResponse status;
        
        public getStatusResponse() {
        }
        
        public getStatusResponse(Services.ServiceReference1.statusResponse status) {
            this.status = status;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface billServiceChannel : Services.ServiceReference1.billService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class billServiceClient : System.ServiceModel.ClientBase<Services.ServiceReference1.billService>, Services.ServiceReference1.billService {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Services.ServiceReference1.getStatusResponse Services.ServiceReference1.billService.getStatus(Services.ServiceReference1.getStatusRequest request) {
            return base.Channel.getStatus(request);
        }
        
        public Services.ServiceReference1.statusResponse getStatus(string ticket) {
            Services.ServiceReference1.getStatusRequest inValue = new Services.ServiceReference1.getStatusRequest();
            inValue.ticket = ticket;
            Services.ServiceReference1.getStatusResponse retVal = ((Services.ServiceReference1.billService)(this)).getStatus(inValue);
            return retVal.status;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Services.ServiceReference1.getStatusResponse> Services.ServiceReference1.billService.getStatusAsync(Services.ServiceReference1.getStatusRequest request) {
            return base.Channel.getStatusAsync(request);
        }
        
        public System.Threading.Tasks.Task<Services.ServiceReference1.getStatusResponse> getStatusAsync(string ticket) {
            Services.ServiceReference1.getStatusRequest inValue = new Services.ServiceReference1.getStatusRequest();
            inValue.ticket = ticket;
            return ((Services.ServiceReference1.billService)(this)).getStatusAsync(inValue);
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Services.ServiceReference1.sendPackResponse Services.ServiceReference1.billService.sendPack(Services.ServiceReference1.sendPackRequest request) {
            return base.Channel.sendPack(request);
        }
        
        public string sendPack(string fileName, byte[] contentFile, string partyType) {
            Services.ServiceReference1.sendPackRequest inValue = new Services.ServiceReference1.sendPackRequest();
            inValue.fileName = fileName;
            inValue.contentFile = contentFile;
            inValue.partyType = partyType;
            Services.ServiceReference1.sendPackResponse retVal = ((Services.ServiceReference1.billService)(this)).sendPack(inValue);
            return retVal.ticket;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Services.ServiceReference1.sendPackResponse> Services.ServiceReference1.billService.sendPackAsync(Services.ServiceReference1.sendPackRequest request) {
            return base.Channel.sendPackAsync(request);
        }
        
        public System.Threading.Tasks.Task<Services.ServiceReference1.sendPackResponse> sendPackAsync(string fileName, byte[] contentFile, string partyType) {
            Services.ServiceReference1.sendPackRequest inValue = new Services.ServiceReference1.sendPackRequest();
            inValue.fileName = fileName;
            inValue.contentFile = contentFile;
            inValue.partyType = partyType;
            return ((Services.ServiceReference1.billService)(this)).sendPackAsync(inValue);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Services.ServiceReference1.sendSummaryResponse Services.ServiceReference1.billService.sendSummary(Services.ServiceReference1.sendSummaryRequest request) {
            return base.Channel.sendSummary(request);
        }
        
        public string sendSummary(string fileName, byte[] contentFile, string partyType) {
            Services.ServiceReference1.sendSummaryRequest inValue = new Services.ServiceReference1.sendSummaryRequest();
            inValue.fileName = fileName;
            inValue.contentFile = contentFile;
            inValue.partyType = partyType;
            Services.ServiceReference1.sendSummaryResponse retVal = ((Services.ServiceReference1.billService)(this)).sendSummary(inValue);
            return retVal.ticket;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Services.ServiceReference1.sendSummaryResponse> Services.ServiceReference1.billService.sendSummaryAsync(Services.ServiceReference1.sendSummaryRequest request) {
            return base.Channel.sendSummaryAsync(request);
        }
        
        public System.Threading.Tasks.Task<Services.ServiceReference1.sendSummaryResponse> sendSummaryAsync(string fileName, byte[] contentFile, string partyType) {
            Services.ServiceReference1.sendSummaryRequest inValue = new Services.ServiceReference1.sendSummaryRequest();
            inValue.fileName = fileName;
            inValue.contentFile = contentFile;
            inValue.partyType = partyType;
            return ((Services.ServiceReference1.billService)(this)).sendSummaryAsync(inValue);
        }
    }
}
